...
if __name__ == "__main__":
    ...
    # embedding1_1 = santiment_scorer.generateEmbeddings("Relaxation")
    # embedding1_2 = santiment_scorer.generateEmbeddings("Sadness")
    # embedding1_3 = santiment_scorer.generateEmbeddings("Excitment")
    # embedding2 = santiment_scorer.generateEmbeddings("admiration")
    # embedding3 = santiment_scorer.generateEmbeddings("joy")
    # embedding4 = santiment_scorer.generateEmbeddings("anger")

    # print("distance 1 2: ", santiment_scorer.getDistance(embedding1_1, embedding2))
    # print("distance 1 3: ", santiment_scorer.getDistance(embedding1_1, embedding3))
    # print("distance 1 4: ", santiment_scorer.getDistance(embedding1_1, embedding4))

    # print("distance 2 2: ", santiment_scorer.getDistance(embedding1_2, embedding2))
    # print("distance 2 3: ", santiment_scorer.getDistance(embedding1_2, embedding3))
    # print("distance 2 4: ", santiment_scorer.getDistance(embedding1_2, embedding4))

    # print("distance 3 2: ", santiment_scorer.getDistance(embedding1_3, embedding2))
    # print("distance 3 3: ", santiment_scorer.getDistance(embedding1_3, embedding3))
    # print("distance 3 4: ", santiment_scorer.getDistance(embedding1_3, embedding4))        
    # # print(vector)
